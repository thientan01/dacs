...
function ProductItemColor(props) {
  return (
    <div className="col l-2-4 m-4 c-6 Content-2-container-product-item">
      ...
      <div className="Content-2-container-product-info-detail-laptop">
        <div className="Content-2-container-product-info-detail-laptop-item">
